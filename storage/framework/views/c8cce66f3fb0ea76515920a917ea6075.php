<div class="grid grid-cols-1 md:grid-cols-4 gap-4" wire:poll.5s="loadThreads">
    <div class="md:col-span-1 bg-gray-900 rounded-lg shadow p-4">
        ...
        <div class="space-y-2 max-h-96 overflow-y-auto">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $threads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <div class="md:col-span-3 chat-box rounded-lg shadow p-4 flex flex-col"
        ...
        <div class="flex-1 overflow-y-auto space-y-2 pr-2 relative" wire:poll.5s="loadMessages" x-ref="list" @scroll="atBottom = ($refs.list.scrollTop + $refs.list.clientHeight) >= ($refs.list.scrollHeight - 4)">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH /Users/admin/Desktop/html_blade-codex-move-personal-acc-assets-to-resources-or-public/resources/views/livewire/admin/support-chat.blade.php ENDPATH**/ ?>